...
迁移自旧 core/perception/foreground.py（逻辑原样保留）。
...
平台约束：win32 ctypes 全部延迟在函数内 import，Linux 开发机 import 本模块安全。
"""
from __future__ import annotations

import sys

from capture.screen.mss_source import match_window_title
